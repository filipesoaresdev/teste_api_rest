...
public class NomeServiceTest {
    ...
    @Test
    public void testeInserirListaNome() {

        nomeService.inserirListaNome(List.of("Jose", "João", "Filipe"));
    ...
    @Test(expected = NomeException.class)
    public void testeInserirListaNomeVazio() {
        nomeService.inserirListaNome(List.of("", "João", "Filipe"));
    }

    @Test(expected = NomeException.class)
    public void testeInserirListaNomeComCaracterErrado() {
        nomeService.inserirListaNome(List.of("334", "nome2", "nome3"));
    }
}
